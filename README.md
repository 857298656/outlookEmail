...
The Mailbox view supports cached-message search, read/unread filtering, attachment filtering, pagination, sandboxed HTML body rendering, single-message actions, and batch read/unread/delete actions. Graph and IMAP message actions update the local SQLite cache and attempt remote synchronization. Failed remote mark/delete attempts are queued for manual or scheduled retry.
