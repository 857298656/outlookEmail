...
继续按“桌面版够用，优先补功能”推进。当前桌面优先级中的 P0/P1/P2 项已补齐；M9 已启动并完成首批 Provider Foundation，下一步建议继续 P9.1：Google OAuth URL/token exchange、Gmail 账号保存和 Gmail API 首次只读同步。Web 服务和浏览器扩展暂不处理。
